...
const EmptyCart = () => {
  return (
    <div
    className='py-10 md:py-20 bg-linear-to-b from-blue-50 to white flex items-center justify-center p-4' 
    >
      <motion.div
      ...
      >
        ...
        <div className='text-center space-y-4'>
          ...
          <p className='text-gray-600'>
            It looks like you haven&apos;t added anyhting to your cart yet.
            let&apos;s chnage that and find some amazing products for you!
          </p>
        </div>
