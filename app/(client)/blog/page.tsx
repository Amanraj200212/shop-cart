    ...
    <Container>
      <div className='mb-10 lg:mb-20'>
        <div className='border-b mb-10'>
          <h2 className='text-2xl font-semibold pb-3'>Blog page</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2.5 mt-5">
          {blogs?.map((blog) => (
            <div key={blog?._id} className="rounded-md overflow-hidden border border-shop_dark_green/10 hover:border-shop_dark_green hoverEffect">
              {blog?.mainImage && (
                <Link
